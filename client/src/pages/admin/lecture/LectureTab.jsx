    ...
    <Card className="overflow-hidden rounded-[30px] border border-slate-200/80 bg-white shadow-[0_24px_70px_-40px_rgba(15,23,42,0.35)] dark:border-slate-800 dark:bg-slate-950">
      <CardHeader className="flex flex-col gap-4 border-b border-slate-200/70 bg-slate-50/80 px-6 py-5 dark:border-slate-800 dark:bg-slate-900/40 lg:flex-row lg:items-start lg:justify-between">
        ...
        <Button
          ...
          className="h-11 rounded-2xl px-5 text-base font-semibold"
        >
          {removeLoading ? (
            <>
      ...
      <CardContent className="space-y-6 p-6 md:p-8">
          ...
          <div className="space-y-6">
            ...
            <div className="rounded-3xl border border-slate-200 bg-white p-5 shadow-sm dark:border-slate-800 dark:bg-slate-950/70">
              ...
              <div className="mt-4 rounded-2xl border border-slate-200 bg-white p-4 dark:border-slate-800 dark:bg-slate-950">
                ...
                <div className="mt-3 flex items-center gap-3 rounded-2xl border border-slate-200 bg-slate-50 px-4 py-3 dark:border-slate-800 dark:bg-slate-900/70">
            ...
            <div className="rounded-3xl border border-slate-200 bg-white p-5 shadow-sm dark:border-slate-800 dark:bg-slate-950/70">
              <div className="flex items-center justify-between gap-3">
                ...
                <Button type="button" variant="outline" className="rounded-2xl" onClick={addQuestion}>
              ...
              <div className="mt-4 flex justify-end">
                <Button type="button" onClick={saveQuizHandler} disabled={quizLoading} className="rounded-2xl">
                  {quizLoading ? (
                    <>
                      <Loader2 className="mr-2 h-4 w-4 animate-spin" />
                      Saving quiz...
            ...
            {mediaProgress && (
              <div className="rounded-3xl border border-blue-100 bg-[linear-gradient(135deg,#eff6ff_0%,#dbeafe_100%)] p-5 dark:border-cyan-500/20 dark:bg-[linear-gradient(135deg,rgba(8,47,73,0.8)_0%,rgba(12,74,110,0.4)_100%)]">
        ...
        <div className="flex flex-col gap-3 border-t border-slate-200 pt-6 dark:border-slate-800 sm:flex-row sm:items-center sm:justify-between">
          ...
          <Button
            ...
            className="h-12 rounded-2xl bg-blue-600 px-6 text-base font-semibold hover:bg-blue-700 dark:bg-cyan-500 dark:text-slate-950 dark:hover:bg-cyan-400"
          >
            {isLoading ? (
              <>
                <Loader2 className="mr-2 h-4 w-4 animate-spin" />
